...
# 父目录 第一个是参数名称，第二个参数是默认值，第三个是参数描述
tf.flags.DEFINE_string("parent_dir",  "audio",  "Data source for the data.")
# 子目录
tf.flags.DEFINE_string("sub_dirs",  "1, 2, 3, 4, 5",  "Data source for the data.")
...
# 分类数
tf.flags.DEFINE_integer("n_classes",  22,  "Number of classes (default: 22)")
# 学习率
...
# 获得训练用的wav文件路径列表
wav_files = get_wav_files(FLAGS.parent_dir, FLAGS.sub_dirs)
# 获取文件mfcc特征和对应标签train_labels[11 11 11...53 53]
...
#             #                                                                              learning_rate))
#             print("Iter {}, tr_acc {:.5f}, ts_acc {:.5f}, lr {:.5f}".format(i,tr_acc, ts_acc,
#                                                                                          learning_rate))
#         # 保存模型
